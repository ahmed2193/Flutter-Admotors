...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    // ignore: unnecessary_this
        ...
        // ignore: unnecessary_this
        this.theme = theme ?? const DatePickerTheme1(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    final DatePickerTheme1 theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerTheme1 theme) {
  ...
  Widget _renderItemView(DatePickerTheme1 theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerTheme1 theme) {
