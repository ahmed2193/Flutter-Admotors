...
class PsApiService extends PsApi {
  ...
  Future<PsResource<List<Manufacturer>>> getManufacturerList(
      ...
      int limit, int offset) async {
    final String url =
        '${PsUrl.ps_manufacturer_url}/api_key/${PsConfig.ps_api_key}/limit/$limit/offset/$offset/login_user_id/$loginUserId';

    return await postData<Manufacturer, List<Manufacturer>>(
        Manufacturer(), url,jsonMap);
  }
  ...
  Future<PsResource<List<Model>>> getModelList(
    ...
    final String url =
        '${PsUrl.ps_model_url}/api_key/${PsConfig.ps_api_key}/limit/$limit/offset/$offset/login_user_id/$loginUserId';

    return await postData<Model, List<Model>>(Model(), url,jsonMap);
  }

  Future<PsResource<List<Model>>> getAllModelList(Map<dynamic, dynamic> jsonMap) async {
    const String url =
        '${PsUrl.ps_model_url}/api_key/${PsConfig.ps_api_key}';
  ...
  Future<PsResource<List<ItemLocation>>> getItemLocationList(Map<dynamic, dynamic> jsonMap,
    ...
    return await getServerCall<ItemLocationTownship,
        List<ItemLocationTownship>>(ItemLocationTownship(), url);
  }
