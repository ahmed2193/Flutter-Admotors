...
class AppSetting extends PsObject<AppSetting> {
  AppSetting({
    ...
    this.longitude, 
    this.isSubLocation,
    this.isThumbnail2x3xGenerate, 
    this.isBlockedDisabled, 
    this.isPaidApp,
    this.isModelSubScribe,
    this.maxImageCount,
    this.adType,
    this.promoCellNo});
  ...
  AppSetting fromMap(dynamic dynamicData) {
   // if (dynamicData != null) {
      return AppSetting(
          ...
          isThumbnail2x3xGenerate: dynamicData['is_thumb2x_3x_generate'],
          isBlockedDisabled: dynamicData['is_block_user'],
          isPaidApp: dynamicData['is_paid_app'],
          isModelSubScribe: dynamicData['is_subcat_subscription'],
  ...
  Map<String, dynamic>? toMap(dynamic object) {
    if (object != null) {
      ...
      data['is_thumb2x_3x_generate'] = object.isThumbnail2x3xGenerate;
      data['is_block_user'] = object.isBlockedDisabled;
      data['is_paid_app'] = object.isPaidApp;
      data['is_subcat_subscription'] = object.isModelSubScribe;
