...
class Product extends PsObject<Product> {
  ...
  Product fromMap(dynamic dynamicData) {
   // if (dynamicData != null) {
      return Product(
        ...
        itemLocationTownship: ItemLocationTownship().fromMap(dynamicData['item_location_township']),
        conditionOfItem:
  ...
  Map<String, dynamic>? toMap(dynamic object) {
    if (object != null) {
      ...
      data['item_location_township'] =ItemLocationTownship().toMap(object.itemLocationTownship);
