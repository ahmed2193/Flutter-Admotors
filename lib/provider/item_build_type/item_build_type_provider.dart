...
class ItemBuildTypeProvider extends PsProvider {
 ...
 late StreamController<PsResource<List<ItemBuildType>>> itemBuildTypeListStream;

  late ItemBuildTypeRepository _repo;
  ...
  late StreamSubscription<PsResource<List<ItemBuildType>>> subscription;
