...
class TrendingManufacturerProvider extends PsProvider {
 ...
 late StreamController<PsResource<List<Manufacturer>>> categoryListStream;
 late ManufacturerRepository _repo;
  ...
  Future<dynamic> loadTrendingManufacturerList(
    ...
    await _repo.getManufacturerList(categoryListStream, jsonMap, loginUserId, isConnectedToInternet,
  ...
  Future<dynamic> nextTrendingManufacturerList(
    ...
    if (!isLoading && !isReachMaxData) {
      ...
      await _repo.getNextPageManufacturerList(categoryListStream,
          jsonMap, loginUserId,isConnectedToInternet, limit, offset!, PsStatus.PROGRESS_LOADING);
    }
  }
