...
class ItemColorProvider extends PsProvider {
  ...
  late StreamController<PsResource<List<ItemColor>>> itemColorListStream;

  late ItemColorRepository _repo;
 ...
 late  StreamSubscription<PsResource<List<ItemColor>>> subscription;
