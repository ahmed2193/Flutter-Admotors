...
class TransmissionProvider extends PsProvider {
 ...
 late StreamController<PsResource<List<Transmission>>> transmissionListStream;

 late TransmissionRepository _repo;
 ...
 late StreamSubscription<PsResource<List<Transmission>>> subscription;
