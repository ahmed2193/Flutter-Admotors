...
class ItemSellerTypeProvider extends PsProvider {
 ...
 late StreamController<PsResource<List<ItemSellerType>>> itemSellerTypeListStream;

 late ItemSellerTypeRepository _repo;
  ...
  PsResource<List<ItemSellerType>> get itemSellerTypeList =>
      _itemSellerTypeList;
  late StreamSubscription<PsResource<List<ItemSellerType>>> subscription;
