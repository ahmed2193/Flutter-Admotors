...
class ItemFuelTypeProvider extends PsProvider {
  ...
  late StreamController<PsResource<List<ItemFuelType>>> itemFuelTypeListStream;

 late ItemFuelTypeRepository _repo;
  ...
  late StreamSubscription<PsResource<List<ItemFuelType>>> subscription;
