...
import 'package:flutteradmotors/ui/common/dialog/share_app_dialog.dart';
...
import 'package:flutteradmotors/ui/faq/menu_faq_view.dart';
...
import 'package:flutteradmotors/ui/item/paid_ad_product/paid_ad_product_list_view.dart';
...
import 'package:flutteradmotors/ui/privacy_policy/menu_privacy_policy_view.dart';
...
import 'package:flutteradmotors/ui/terms_and_conditions/menu_terms_and_conditions_view.dart';
...
class _HomeViewState extends State<DashboardView>
 ...
 late AnimationController  animationControllerForFab;
  ...
  Widget build(BuildContext context) {
    ...
    final ProductParameterHolder latestParameterHolder = ProductParameterHolder().getLatestParameterHolder();
    latestParameterHolder.mile = psValueHolder!.mile;
    final ProductParameterHolder recentParameterHolder = ProductParameterHolder().getRecentParameterHolder();
    recentParameterHolder.mile = psValueHolder!.mile;
    final ProductParameterHolder popularParameterHolder = ProductParameterHolder().getPopularParameterHolder();
            ...
            child: Consumer<UserProvider>(
              builder:
                ...
                return ListView(padding: EdgeInsets.zero, children: <Widget>[
                  ...
                  // ignore: unnecessary_null_comparison
                  if (psValueHolder!.isPaidApp == PsConst.ONE && provider != null && provider.psValueHolder!.loginUserId != null &&
                      provider.psValueHolder!.loginUserId != '')
                    Visibility(
                      visible: true,
                      child: _DrawerMenuWidget(
...
class _CallLoginWidget extends StatelessWidget {
  const _CallLoginWidget(
      ...
      required this.userUnreadMessageProvider});
