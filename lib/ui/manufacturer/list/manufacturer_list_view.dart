  ...
  void initState() {
    widget.scrollController.addListener(() {
      if (widget.scrollController.position.pixels ==
        ...
        _categoryProvider!.nextManufacturerList(_categoryProvider!.manufacturerParameterHolder.toMap(),
                    ...
                    child: Stack(children: <Widget>[
                      Container(
                          ...
                          child: RefreshIndicator(
                            ...
                            onRefresh: () {
                              return provider.resetManufacturerList(provider.manufacturerParameterHolder.toMap(),
                                     psValueHolder!.loginUserId!);
                            },
                          )),
                      PSProgressIndicator(
