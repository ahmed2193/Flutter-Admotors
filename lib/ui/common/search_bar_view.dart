...
class SearchBarView {
  ...
  /// A callback which should return an AppBar that is displayed until search is started. One of the actions in this AppBar should be a search button which you obtain from SearchBarView.getSearchAction(). This will be called every time search is ended, etc. (like a build method on a widget)
  ...
  /// title is always a [TextField] with the key 'SearchBarViewTextField', and various text stylings based on [inBar]. This is also where [onSubmitted] has its listener registered.
  ///
  AppBar buildSearchBarView(BuildContext context) {
   ...
   // final Color? buttonColor = inBar ? null : theme.iconTheme.color;
    ...
    return AppBar(
      ...
      leading: IconButton(
          ...
          color: Utils.isLightMode(context) ? PsColors.mainColor : Colors.white,
      ...
      title: Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: PsDimens.space8),
            decoration: BoxDecoration(
              color: PsColors.backgroundColor,//PsColors.primary50,
        ...
        child: Directionality(
          ...
          child: TextField(
            key: const Key('SearchBarViewTextField'),
  ...
  AppBar? build(BuildContext context) {
    return isSearching.value ? buildSearchBarView(context) : buildAppBar(context);
  }
}
