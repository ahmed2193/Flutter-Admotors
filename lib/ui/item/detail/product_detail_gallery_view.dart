            ...
            children: <Widget>[
              ...
              Positioned(
                  ...
                  child: Row(
                    ...
                    children://provider.tempGalleryList != null &&
...
// class GallerySliderView extends StatefulWidget {
...
//   @override
//   _GallerySliderViewState createState() => _GallerySliderViewState();
// }

// class _GallerySliderViewState extends State<GallerySliderView> {
//   String _currentId;
//   @override
//   Widget build(BuildContext context) {
//     final GalleryRepository galleryRepo =
...
//               selectedIndex = i;
//               // _currentId = provider.galleryList.data[i].imgId;
//               break;
//             }
//           }
...
//               mainAxisSize: MainAxisSize.min,
//               mainAxisAlignment: MainAxisAlignment.center,
//               children: provider.galleryList != null && provider.galleryList.data.isNotEmpty
//                   ? provider.galleryList.data.map((DefaultPhoto defaultPhoto) {
//                       return Builder(builder: (BuildContext context) {
//                         return Container(
//                             width: 8.0,
//                             height: 8.0,
...
//                             decoration: BoxDecoration(
//                                 shape: BoxShape.circle,
//                                 color: _currentId == defaultPhoto.imgParentId
//                                     ? PsColors.mainColor
//                                     : PsColors.grey));
//                       });
//                     }).toList()
