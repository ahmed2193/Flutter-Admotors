...
import 'package:flutteradmotors/ui/common/dialog/choose_payment_type_dialog.dart';
...
import 'package:flutteradmotors/ui/item/detail/product_detail_gallery_view.dart';
import 'package:flutteradmotors/ui/item/detail/views/faq_tile_view.dart';
...
import 'package:flutteradmotors/ui/item/detail/views/terms_and_conditions_view.dart';
import 'package:flutteradmotors/ui/rating/item/rating_list_item.dart';
                                                                ...
                                                                return ConfirmDialogView(
                                                                    ...
                                                                    onAgreeTap:
                                                                      ...
                                                                      await PsProgressDialog
                                                                          .showDialog(
                                                                              context);
                                                                      markSoldOutItemProvider.loadmarkSoldOutItem(
                                                                          psValueHolder!
                                                                              .loginUserId!,
                                                                          markSoldOutItemHolder!);
                                                                      PsProgressDialog
                                                                          .dismissDialog();
                                                                      if (
                                                                          // markSoldOutItemProvider.markSoldOutItem !=
                                                                          //       null &&
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          const SizedBox(
                                                              width: PsDimens
                                                                  .space12),
                                                          Text(
                                                            (!Utils.showUI(psValueHolder!.video)) ?
                                                            '${provider.itemDetail.data!.photoCount}  ${Utils.getString(context, 'item_detail__photo')}' :
                                                            '${provider.itemDetail.data!.photoCount}  ${Utils.getString(context, 'item_detail__photo')}, ${provider.itemDetail.data!.videoCount}  ${Utils.getString(context, 'item_detail__video')}',
                                                            style: Theme.of(
                                                                    context)
                                                                .textTheme
                                                                .bodyLarge!
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    Utils.showUI(psValueHolder!.discountRate)
                ...
                if (Utils.showUI(psValueHolder!.condition))
                  Padding(
                    padding: const EdgeInsets.only(right: PsDimens.space16),
                    child: Text(
                      widget
                          .itemDetail!.itemDetail.data!.conditionOfItem!.name!,
                      style: Theme.of(context).textTheme.bodyLarge,
                    ),
                  ),
              ],
            ...
            Visibility(
                visible: Utils.showUI(psValueHolder!.discountRate) &&
                    widget.itemDetail!.itemDetail.data!.discountRate != '0',
                child: Row(
                  children: <Widget>[
                    Padding(
                      padding: const EdgeInsets.only(left: PsDimens.space16),
            ...
            if (Utils.showUI(psValueHolder!.highlightInfo) &&
    ...
    return CustomScrollView(
      ...
      slivers: <Widget>[
        SliverGrid.count(
          crossAxisCount: 3,
          children: <Widget>[
            if (Utils.showUI(psValueHolder!.plateNumber))
            ...
            if (Utils.showUI(psValueHolder!.enginePower))
              _IconsAndDescriptionTextWidget(
                icon: FontAwesome.file_powerpoint,
                title: Utils.getString(
                  context,
            ...
            if (Utils.showUI(psValueHolder!.transmissionId))
              _IconsAndDescriptionTextWidget(
            ...
            if (Utils.showUI(psValueHolder!.mileage))
              _IconsAndDescriptionTextWidget(
                icon: Icons.cabin,
                title: Utils.getString(
                  context,
            ...
            if (Utils.showUI(psValueHolder!.licenceExpirationDate))
              _IconsAndDescriptionTextWidget(
                icon: Icons.warning,
                title: Utils.getString(
                  context,
                ...
                desctiption: itemData.licenseExpirationDate == ''
                    ? '-'
                    : Utils.getDateFormat(itemData.licenseExpirationDate!, psValueHolder!.dateFormat!),
              ),
            if (Utils.showUI(psValueHolder!.year))
              _IconsAndDescriptionTextWidget(
...
class _EditAndDeleteButtonWidget extends StatefulWidget {
  ...
  @override
  __EditAndDeleteButtonWidgetState createState() => __EditAndDeleteButtonWidgetState();
}

class __EditAndDeleteButtonWidgetState extends State<_EditAndDeleteButtonWidget> {
                                  ...
                                  return ConfirmDialogView(
                                      ...
                                      onAgreeTap: () async {
                                        final UserDeleteItemParameterHolder
                                            ...
                                            UserDeleteItemParameterHolder(
                                          itemId: widget.provider.itemDetail.data!.id,
                                        );
                            ...
                            onPressed: () async {
                              final dynamic entryData = await Navigator.pushNamed(
                                  ...
                                  arguments: ItemEntryIntentHolder(
                                      ...
                                      item: widget.provider.itemDetail.data!));
                              if (entryData != null &&
                                  entryData is bool &&
                                  entryData) {
                                setState(() {
                                ...
                                await widget.galleryProvider!.loadImageList(widget.provider.itemDetail.data!.id, PsConst.ITEM_TYPE);        
                              //  await widget.galleryProvider!.loadImageList(widget.provider.itemDetail.data!.id, PsConst.ITEM_TYPE);        
