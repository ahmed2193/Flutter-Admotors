...
class NearestProductListView extends StatefulWidget {
  ...
  @override
  _NearestProductListViewState createState() =>
      _NearestProductListViewState(tabTitleItem, tabTitleAccount);
}

class _NearestProductListViewState
    extends State<NearestProductListView>
    with TickerProviderStateMixin {
  _NearestProductListViewState(
