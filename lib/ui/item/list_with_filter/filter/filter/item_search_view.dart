  ...
  Widget build(BuildContext context) {
    ...
    final Widget _searchButtonWidget = PSButtonWidget(
        ...
        onPressed: () {
          ...
          // ignore: unnecessary_null_comparison
          if (_searchProductProvider.itemSoldOutId != null) {
            _searchProductProvider.productParameterHolder.isSoldOut =
                _searchProductProvider.itemSoldOutId;
            _searchProductProvider.productParameterHolder.soldOutName =
                _searchProductProvider.selectedSoldOutName;
          }
          // ignore: unnecessary_null_comparison
    ...
    return PsWidgetWithAppBar<SearchProductProvider>(
        ...
        onProviderReady: (SearchProductProvider provider) {
          ...
          _searchProductProvider.selectedSoldOutName =
              widget.productParameterHolder.soldOutName!;
          _searchProductProvider.selectedFuelType =
                          ...
                          onTap: () async {
                            ...
                            final dynamic soldOutResult =
                                await Navigator.pushNamed(
                                    ...
                                    arguments: provider.selectedSoldOutName);

                            if (soldOutResult != null &&
                                soldOutResult is Product) {
                              provider.itemSoldOutId = soldOutResult.isSoldOut!;
                              if (mounted) {
                                setState(() {
                                  provider.selectedSoldOutName =
                                      soldOutResult.isSoldOut == PsConst.ZERO
                                          ? 'Not Sold Yet'
                                          : 'Sold Out';
                                });
                              }
