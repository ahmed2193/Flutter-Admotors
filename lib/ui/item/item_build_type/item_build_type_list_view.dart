  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<ItemBuildTypeProvider>(
          ...
          actions: <Widget>[
            IconButton(
                icon: Icon(Icons.remember_me, color: PsColors.mainColor),
                onPressed: () {
                  if (mounted) {
                    setState(() {
                      selectedName = '';
          ...
          builder: (BuildContext context, ItemBuildTypeProvider provider,
              Widget? child) {
            return Stack(children: <Widget>[
              Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (provider.itemBuildTypeList.status ==
                        ...
                        final int count =
                            provider.itemBuildTypeList.data!.length;
              ...
              PSProgressIndicator(
                provider.itemBuildTypeList.status,
