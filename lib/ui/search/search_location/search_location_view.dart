...
import 'package:flutteradmotors/ui/search/search_location/search_location_list_view_item.dart';
...
class SearchLocationViewState extends State<SearchLocationView>
  ...
  ItemLocationProvider? _itemLocationTownshipProvider;
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _itemLocationTownshipProvider!.nextItemLocationList(
            _itemLocationTownshipProvider!.defaultLocationParameterHolder.toMap(),
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<ItemLocationProvider>(
          ...
          onProviderReady: (ItemLocationProvider provider) {
            provider.defaultLocationParameterHolder.keyword =
                searchNameController.text;
            provider.loadItemLocationList(
                provider.defaultLocationParameterHolder.toMap(),
