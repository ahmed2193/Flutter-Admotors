  ...
  Widget build(BuildContext context) {
    ...
    return PsWidgetWithAppBar<NotificationProvider>(
        ...
        builder: (BuildContext context, NotificationProvider provider,
            Widget? child) {
          return _NotificationSettingWidget(notiProvider: provider, psValueHolder: _psValueHolder);
        });
  }
}

class _NotificationSettingWidget extends StatefulWidget {
  const _NotificationSettingWidget({this.notiProvider, this.psValueHolder});
