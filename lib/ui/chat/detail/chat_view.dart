...
import 'package:flutteradmotors/viewobject/holder/make_is_user_bought_parameter_holder.dart';
...
class _ChatViewState extends State<ChatView>
  ...
  void initState() {
    ...
    // (database != null && database.databaseURL != null) {
  ...
  Future<void> _insertSenderAndReceiverToFireBase(
    ...
    _userPresence!
        .child(senderId)
        .set(chatUserPresence.toMap(chatUserPresence));
  }
  ...
  Widget build(BuildContext context) {
    ...
    _chatRef!.child(otherUserId).onValue.listen((dynamic? event) {
                            ...
                            child: FirebaseAnimatedList(
                              ...
                              sort: _anchorToBottom
                                  ? (DataSnapshot a, DataSnapshot b) {
                                      final Map<String, dynamic> aValue =
                                          a.value as Map<String, dynamic>;
                                      final Map<String, dynamic> bValue =
                                          b.value as Map<String, dynamic>;

                                      final String aAddedDate =
                                          aValue['addedDate'].toString();
                                      final String bAddedDate =
                                          bValue['addedDate'].toString();

                                      return bAddedDate.compareTo(aAddedDate);
                                    }
                                  : null,
      ...
      if (widget.messageObj.type == PsConst.CHAT_TYPE_TEXT) {
        if (widget.messageObj.offerStatus == PsConst.CHAT_STATUS_OFFER) {
          ...
          return _ChatTextReceiverWidget(
              widget: widget, itemDetail: widget.itemDetail!);
        }
      } else if (widget.messageObj.type == PsConst.CHAT_TYPE_OFFER) {
        ...
        if (widget.index == 0) {
          widget.checkOfferStatus!(widget.chatHistoryProvider.chatHistory.data);
        }
...
// 'dddd'
            ...
            Consumer<GetChatHistoryProvider>(builder: (BuildContext context,
              ...
              // Fluttertoast.showToast(
              //                         msg: getChatHistoryProvider.chatHistory.data.isOffer,
              //                         toastLength: Toast.LENGTH_SHORT,
              //                         gravity: ToastGravity.BOTTOM,
              //                         timeInSecForIosWeb: 1,
              //                         backgroundColor: PsColors.mainColor,
