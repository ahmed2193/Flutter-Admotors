...
class _ChooseManufacturerListViewState extends State<ChooseManufacturerListView>
  ...
  void initState() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _manufacturerProvider!.nextManufacturerList(_manufacturerProvider!.manufacturerParameterHolder.toMap(),
                Utils.checkUserLoginId(_manufacturerProvider!.psValueHolder!));
      }
    });
  ...
  late ManufacturerRepository repo1;
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<ManufacturerProvider>(
          ...
          onProviderReady: (ManufacturerProvider provider) {
            provider.loadManufacturerList(_manufacturerProvider!.manufacturerParameterHolder.toMap(),
                Utils.checkUserLoginId(_manufacturerProvider!.psValueHolder!));
          ...
          builder: (BuildContext context, ManufacturerProvider provider,
            ...
            return Stack(children: <Widget>[
              ...
              RefreshIndicator(
                ...
                onRefresh: () {
                  return provider.resetManufacturerList(_manufacturerProvider!.manufacturerParameterHolder.toMap(),
                Utils.checkUserLoginId(_manufacturerProvider!.psValueHolder!));
                },
              ),
              // ),
