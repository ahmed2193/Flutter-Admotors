  ...
  void initState() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _modelProvider!.nextModelList(
            _modelProvider!.modelParameterHolder.toMap(),
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<ModelProvider>(
          ...
          onProviderReady: (ModelProvider provider) {
            provider.modelParameterHolder.manufacturerId = widget.categoryId;
            provider.loadModelList(provider.modelParameterHolder.toMap(),
                psValueHolder!.loginUserId!);
          ...
          builder:
            ...
            return Stack(children: <Widget>[
              Container(
                ...
                onRefresh: () {
                  return provider.resetModelList(
